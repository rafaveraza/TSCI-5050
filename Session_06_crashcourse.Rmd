...
Let's find out.
```{r}
try(sexbmiagerace.lmeA <- update(sexbmiage.lmeA,.~.:RACE+RACE,control=lmec));
try(sexbmiagerace.lmeB <- update(sexbmiage.lmeB,.~.:RACE+RACE,control=lmec));
if('sexbmiagerace.lmeA'%in%names(.GlobalEnv)) anova(sexbmiage.lmeA,sexbmiagerace.lmeA);
if('sexbmiagerace.lmeB'%in%names(.GlobalEnv)) anova(sexbmiage.lmeB,sexbmiagerace.lmeB);
plot(sexbmiagerace.lmeB,level=0);
summary(sexbmiagerace.lmeB);
```
